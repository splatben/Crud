...
try {
    ...
    $html->appendButtonToMenu("admin/seasonForm.php?seasonId={$season->getId()}", "Modifier");
    $html->appendButtonToMenu("admin/season-deletephp?seasonId={$season->getId()}", "Supprimer");
    $html->appendCss(
        <<<CSS
    .Season,.Episode{
    display: flex;
